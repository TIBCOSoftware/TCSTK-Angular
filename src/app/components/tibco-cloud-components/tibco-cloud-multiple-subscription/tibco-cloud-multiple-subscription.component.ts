 ...
 *
 * @description
 * `<app-tibco-cloud-subscription-component>` is a component providing the ability for a user to login to
 ...
 * @usage
 *
 * <app-tibco-cloud-multiple-subscription *ngIf="subRequired && !loggedIn" [subscriptions]="subscriptions"
 *    [token]="token" (subscriptionSelection)="handleLoggedIn($event)"></app-tibco-cloud-multiple-subscription>
 *
...
@Component({
    selector: 'app-tibco-cloud-multiple-subscription',
...
export class TibcoCloudMultipleSubscriptionComponent {
  ...
  @Output() subscriptionSelection = new EventEmitter();
    ...
    private selectedSubscriptionId;
